...
use Farmero\servergui\commands\ServerGUICommand;

class ServerGUI extends PluginBase {
    ...
    public function onEnable(): void {
        ...
        $this->getServer()->getCommandMap()->register("ServerGUI", new ServerGUICommand($this));
    }
